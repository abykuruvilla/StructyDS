...
- [x] 1. [Running Sum](https://github.com/abykuruvilla/StructyDS/blob/master/src/com/kaby/ds/mixed/RunningSum.java)
- [ ] 2. Has Subarray Sum
...
- [ ] 5. Linked List Cycle - gb75 - (Easy - Linked List)
- [ ] 6. Valid Palindrome - gb75 - (Easy - String)
- [ ] 7. Valid Anagram - gb75 - (Easy - String)
- [ ] 8. Invert Binary Tree - gb75 - (Easy - Binary Tree)
- [ ] 9. Maximum Depth of Binary Tree - gb75 - (Easy - Binary Tree)
- [ ] 10. Number of Islands - gb75 - (Medium - Graph)
- [ ] 11. Clone Graph - b75 - (Medium - Graph)
...
- [ ] 18. Longest Substring Without Repeating Characters - gb75 - (Medium - String)
- [ ] 19. Group Anagrams - b75 - (Medium - String)
- [ ] 20. Validate Binary Search Tree - gb75 - (Medium - Binary Search Tree)
- [ ] 21. Lowest Common Ancestor of a Binary Search Tree - gb75 - (Easy - Binary Search Tree- )

**Week 3**

- [ ] 22. Merge Two Sorted Lists - gb75 - (Easy - Linked List)
- [ ] 23. Remove Nth Node From End of List - b75 - (Medium - Linked List)
- [ ] 24. Course Schedule - gb75 - (Medium - Graph)
- [ ] 25. Pacific Atlantic Water Flow - b75 - (Medium - Graph)
- [ ] 26. Merge Intervals - gb75 - (Medium - Array)
- [ ] 27. Insert Interval - b75 - (Medium - Array)
- [ ] 28. Top K Frequent Elements - gb75 - (Medium - Heap)
- [ ] 29. K Closest Points to Origin - g75 - (Medium - Heap)
- [ ] 30. Coin Change - gb75 - (Medium - Dynamic Programming)
- [ ] 31. Word Break - gb75 - (Medium - Dynamic Programming)

**Week 4**

- [ ] 32. Container With Most Water - gb75 - (Medium - Array)
- [ ] 33. 3Sum - gb75 - (Medium - Array)
- [ ] 34. Minimum Window Substring - gb75 - (Hard - String)
- [ ] 35. Longest Repeating Character Replacement - b75 - (Medium - String)
- [ ] 36. Binary Tree Maximum Path Sum - gb75 - (Hard - Binary Tree)
- [ ] 37. Binary Tree Level Order Traversal - gb75 - (Medium - Binary Tree)
- [ ] 38. Alien Dictionary (Leetcode Premium) - b75 - (Hard - Graph)
- [ ] 39. Number of Connected Components in an Undirected Graph - b75 - (Medium - Graph)
- [ ] 40. Rotate Image - b75 - (Medium - Matrix)

**Week 5**

- [ ] 41. Find Minimum in Rotated Sorted Array - b75 - (Medium - Array)
- [ ] 42. Search in Rotated Sorted Array - gb75 - (Medium - Array)
- [ ] 43. Valid Parentheses - gb75 - (Easy - String)
- [ ] 44. Longest Palindromic Substring - gb75 - (Medium - String)
- [ ] 45. Decode Ways - b75 - (Medium - Dynamic Programming)
- [ ] 46. Partition Equal Subset Sum - g75 - (Medium - Dynamic Programming)
- [ ] 47. Find Median from Data Stream - gb75 - (Hard - Heap)
- [ ] 48. Task Scheduler - g75 - (Medium - Heap)
- [ ] 49. Subtree of Another Tree - b75 - (Medium - Binary Tree)
- [ ] 50. Binary Tree Right Side View - g75 - (Medium - Binary Tree)

**Week 6**

- [ ] 51. Longest Consecutive Sequence - b75 - (Medium - Graph)
- [ ] 52. Rotting Oranges - g75 - (Medium - Graph)
- [ ] 53. Reorder List - b75 - (Medium - Linked List)
- [ ] 54. Merge K Sorted Lists - gb75 - (Hard - Linked List)
- [ ] 55. 01 Matrix - g75 - (Medium - Matrix)
- [ ] 56. Word Search II - b75 - (Hard - Matrix)
- [ ] 57. First Bad Version - g75 - (Easy - Binary Search)
- [ ] 58. Time Based Key-Value Store - g75 - (Medium - Binary Search)
- [ ] 59. Unique Paths - gb75 - (Medium - Dynamic Programming)
- [ ] 60. Jump Game - b75 - (Medium - Dynamic Programming)

**Week 7**

- [ ] 61. Trapping Rain Water - g75 - (Hard - Array)
- [ ] 62. Non-overlapping Intervals - b75 - (Medium - Array)
- [ ] 63. Largest Rectangle in Histogram - g75 - (Hard - Stack)
- [ ] 64. Accounts Merge - g75 - (Medium - Graph)
- [ ] 65. String to Integer (atoi) - g75 - (Medium - String)
- [ ] 66. Find All Anagrams in a String - g75 - (Medium - String)
- [ ] 67. Serialize and Deserialize Binary Tree - gb75 - (Hard - Binary Tree)
- [ ] 68. Construct Binary Tree from Preorder and Inorder Traversal - gb75 - (Medium - Binary Tree)
- [ ] 69. LRU Cache - g75 - (Medium - Linked List)
- [ ] 70. Middle of the Linked List - g75 - (Easy - Linked List)

**Week 8**

- [ ] 71. Word Ladder - g75 - (Hard - Graph)
- [ ] 72. Minimum Height Trees - g75 - (Medium - Graph)
- [ ] 73. Kth Smallest Element in a BST - gb75 - (Medium - Binary Search Tree)
- [ ] 74. Implement Trie (Prefix Tree) - gb75 - (Medium - Trie)
- [ ] 75. Encode and Decode Strings - b75 - (Hard - String)
- [ ] 76. Maximum Profit in Job Scheduling - g75 - (Hard - Binary Search + DP)
- [ ] 77. Combination Sum - gb75 - (Medium - Array)
- [ ] 78. Majority Element - g75 - (Easy - Array)
- [ ] 79. Meeting Rooms - b75 - (Medium - Interval)
- [ ] 80. Meeting Rooms II - b75 - (Medium - Interval)
- [ ] 81. Add Binary - g75 - (Easy - String)
- [ ] 82. Sort Colors - g75 - (Medium - Array)
- [ ] 83. Graph Valid Tree - b75 - (Medium - Graph)
- [ ] 84. House Robber II - b75 - (Medium - Dynamic Programming)
